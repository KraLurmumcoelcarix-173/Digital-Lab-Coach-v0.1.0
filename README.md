...
Active development. Path 1 (external companion tool) prototype.
...
<https://github.com/hneemann/Digital/releases>, extract anywhere
(no install needed), and let the first-run dialog catch your jar.
